...
const bookingSchema = new mongoose.Schema({
  ...
  bookingStatus: { type: String, enum: ["Waiting for Payment", "Reserved", "Pending Payment Verification", "Payment Rejected", "Checked In", "Checked Out", "Cancelled", "Expired"], default: "Waiting for Payment" },
  ...
  rescheduleHistory: [{ previousCheckIn: { type: Date }, previousCheckOut: { type: Date }, newCheckIn: { type: Date }, newCheckOut: { type: Date }, changedAt: { type: Date, default: Date.now }, policyRule: { type: String, default: "" }, inconvenienceFee: { type: Number, default: 0 }, refundAmount: { type: Number, default: 0 } }],
