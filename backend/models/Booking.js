...
const bookingSchema = new mongoose.Schema({
  ...
  securityDepositStatus: { type: String, enum: ["Held", "Refunded", "Withheld"], default: "Held" },
  securityDepositRefundAvailableAt: { type: Date, default: null },
  securityDepositRefundedAt: { type: Date, default: null },
  securityDepositRefundedBy: { type: String, default: "" },
